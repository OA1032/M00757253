...
#    led = led - 1 #or reverse if you want
led = 0
while led<59: #scroll all rows at the same time
    leds[led] = (0,0,255) #row 1 - 0-60
    leds[led+59] = (0,0,255) #row 2 - 0+60 - 59+60 (60-119)
    leds[led+119] = (0,0,255)
    leds[led+179] = (0,0,255) #this can be done in 2 lines instead of 6
    leds[led+239] = (0,0,255)
    leds[led+299] = (0,0,255)
    client.put_pixels(leds)
    time.sleep(.1)
    led = led - 1
